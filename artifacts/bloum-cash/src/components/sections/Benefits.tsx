  ...
  return (
    <section id="avantages" className="py-24 bg-white">
      <div className="container mx-auto px-4 md:px-6 xl:px-8">
        ...
        {/* CSS grid — 1 col → 2 cols → 3 cols → 5 cols — no calc() */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 max-w-7xl mx-auto">
          {benefits.map((benefit, index) => (
            <motion.div
              ...
              className="bg-white border border-slate-100 shadow-sm hover:shadow-md transition-all rounded-[20px] p-6 flex flex-col items-center text-center group"
            >
              <div className="w-14 h-14 rounded-full bg-gradient-to-br from-primary to-blue-700 flex items-center justify-center mb-5 group-hover:-translate-y-2 transition-transform shrink-0">
                {benefit.icon}
              </div>
