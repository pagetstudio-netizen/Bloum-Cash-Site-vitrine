            ...
            },
            {
              ...
              content: [
                ...
                },
                {
                  ...
                  text: "L'accès à vos données est strictement limité aux membres de l'équipe de Ashtech Sarl qui en ont besoin pour accomplir leurs missions (support technique, équipes de sécurité). Chaque accès est tracé et auditable. Nos employés sont formés à la protection des données et soumis à des engagements de confidentialité.",
                },
                {
